Shader "Unlit/WireframeShader"
{
	Properties
	{
		...
		_WireframeFrontColor("Wireframe Front Color", color) = (1.0, 1.0, 1.0, 1.0)
		_WireframeBackColor("Wireframe Back Color", color) = (0.5, 0.5, 0.5, 1.0)
	...
	Pass
	{
			...
			fixed4 frag(g2f i) : SV_Target
			{
				...
				return fixed4(_WireframeFrontColor.r, _WireframeFrontColor.g, _WireframeFrontColor.b, alpha);
			}
		ENDCG
		}
	}
